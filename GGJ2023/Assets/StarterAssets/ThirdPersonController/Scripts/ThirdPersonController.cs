    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            if (_input.move != Vector2.zero)
            {
                ...
                // rotate to face input direction relative to camera position, if set to true (in relation to aiming)
                if (_rotateOnMove)
                {
        ...
        public void SetRotateOnMove(bool newRoatateOnMove)
        {
            _rotateOnMove = newRoatateOnMove;
        }
